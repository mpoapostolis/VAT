...
export function CashFlow() {
  ...
  const totalOperating = cashFlowData.operating.reduce(
    (sum, item) => sum + item.amount,
    0
  );
  const totalInvesting = cashFlowData.investing.reduce(
    (sum, item) => sum + item.amount,
    0
  );
  const totalFinancing = cashFlowData.financing.reduce(
    (sum, item) => sum + item.amount,
    0
  );
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white border border-gray-200/60 shadow-lg shadow-gray-200/20 p-6">
          <div className="space-y-8">
            <div>
              <h2 className="text-xs font-medium mb-4">Operating Activities</h2>
              <div className="space-y-2">
                ...
                <div className="border-t border-gray-100 mt-4 pt-2">
                  <div className="flex justify-between font-medium">
                    ...
                    <span
                      className={
                        totalOperating >= 0 ? "text-green-600" : "text-red-600"
                      }
                    >
            ...
            <div>
              <h2 className="text-xs font-medium mb-4">Investing Activities</h2>
              <div className="space-y-2">
                ...
                <div className="border-t border-gray-100 mt-4 pt-2">
                  <div className="flex justify-between font-medium">
                    ...
                    <span
                      className={
                        totalInvesting >= 0 ? "text-green-600" : "text-red-600"
                      }
                    >
            ...
            <div>
              <h2 className="text-xs font-medium mb-4">Financing Activities</h2>
              <div className="space-y-2">
                ...
                <div className="border-t border-gray-100 mt-4 pt-2">
                  <div className="flex justify-between font-medium">
                    ...
                    <span
                      className={
                        totalFinancing >= 0 ? "text-green-600" : "text-red-600"
                      }
                    >
