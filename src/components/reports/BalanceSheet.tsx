...
const balanceSheetData = {
  ...
  liabilities: {
    ...
    nonCurrent: [
      { name: 'Long-term Debt', amount: 280000 },
    ],
  },
  equity: [
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">View your financial position</p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
            <DateRangePicker />
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-6">
            <div className="bg-white border border-gray-200/60 shadow-lg shadow-gray-200/20 p-6">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-sm font-medium text-gray-500 mb-3">Current Assets</h3>
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500 mb-3">Non-Current Assets</h3>
                  <div className="space-y-2">
          ...
          <div className="space-y-6">
            <div className="bg-white border border-gray-200/60 shadow-lg shadow-gray-200/20 p-6">
              <h2 className="text-lg font-medium mb-4">Liabilities & Equity</h2>

              <div className="space-y-6">
                <div>
                  <h3 className="text-sm font-medium text-gray-500 mb-3">Current Liabilities</h3>
                  <div className="space-y-2">
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500 mb-3">Non-Current Liabilities</h3>
                  <div className="space-y-2">
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500 mb-3">Equity</h3>
                  <div className="space-y-2">
