  ...
  return (
    <div className="relative">
      <button
        ...
        className={cn(
          "flex h-9 w-full text-left items-center justify-between  border bg-white px-3 py-2 text-xs",
        ...
        createPortal(
          ...
          >
            <div
              ...
              className=" border border-gray-200 bg-white py-1 shadow-xl z-[99999] overflow-auto"
            >
              {options.length === 0 ? (
