  ...
  return (
    <div className="overflow-x-auto animate-fade-in">
      <table className="w-full">
        <thead>
          <tr>
            <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 border-b border-gray-200">
              Company Name
            </th>
            <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 border-b border-gray-200">
              Type
        ...
        <tbody className="stagger-animate">
          {transactions.map((transaction) => (
            ...
            >
              ...
              <td className="px-6 py-4">
                <span
                  className={`status-badge inline-flex items-center px-2.5 py-0.5 text-xs font-medium ${
